...
{ [on background layer]
    ...
    ]
    {
        ...
        \begin{tblr-advancedconfigmenu}{
            ...
            & {0C = Disable\\
               1C = Enable}\\
            {+ 1 \HSVchannelmodeboxadv{HSV} channel mode\\
             (hardware-specific)}\\
...
{9H} (Channel Mode Config from ON.315);
...
]
{
    ...
    \normalsize Diagram Release 01\\[4pt]
    Diagram Repository:\\
...
]
{
    ...
    \spacingv
    \textboxauxledcfv{}\\[3pt]
    \smoothPOVDbox{Smooth POVD} (hardware-specific):\\
    resolution of \char"007E{}60 steps instead of 6\\
