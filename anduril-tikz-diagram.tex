...
{ [on above layer]
    \path (OFF.south) edge[
        {Round Cap[sep=2.95cm]}-{Round Cap[sep=3.65cm]},
        anyline,
        anybutton-fill,
        line width=2.4pt,
        out=270,
        ...
        \begin{tblr-advancedconfigmenu}{}
            ...
            2 & {Post-Off \textboxvoltage{} Display\\
              ...
              & {0C = Disable\\
                 ...
                 high if Standby aux LEDs\\
                 are high (7C from Off)}\\
...
% Aux LED settings extra node in Standby
\node (Aux LED settings extra node in Standby)[
