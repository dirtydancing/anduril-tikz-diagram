...
\draw (Ramp 0pt.north) edge[
    {Round Cap[sep=0.7cm]}-{Round Cap[sep=1.8cm]},
    advancedline,
    white,
    line width=2.4pt,
    shorten >=0.2pt,
...
\node (Candle from OFF)[
    advancedconfig-mode,
    above right=0.75cm and 1.3cm of Lightning Storm from Police Strobe.east,
    anchor=west
]
{\oneline{Candle}};
...
]
{
    ...
    \normalsize Diagram Release 39\\[2.0ex]
    Diagram Repository:\\
