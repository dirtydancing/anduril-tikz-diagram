...
\colorlet{advancedconfigtable-draw}{advancedconfig-draw}
\colorlet{advancedconfigtable-fill}{advancedconfig-fill}
\colorlet{advancedconfigtable-text}{advanced-text}
...
\colorlet{simpleUIconfigtable-draw}{advancedconfigtable-draw}
...
\colorlet{anyconfigmode-draw}{advancedconfig-draw}
...
\tikzset{
    ...
    advancedconfigtable/.style={
        advancedconfig,
        draw=advancedconfigtable-draw,
        fill=advancedconfigtable-fill,
        text=advancedconfigtable-text
    },
...
% -0.4pt: 0.5 line thickness for vertical alignment for thick
\coordinate (Factory Reset right) at
    ($(Factory Reset from OFF right.east) + (0.45cm-0.4pt, 0cm)$);
\coordinate (Simple UI switch right) at
    ($(Simple UI switch from OFF right.east) + (0.45cm-0.4pt, 0cm)$);
...
]
{
    ...
    \normalsize Diagram Release 22\\[4pt]
    Diagram Repository:\\
