...
\node (Candle from OFF)[
    advancedconfig-mode,
    above right=0.55cm and 1.2cm of
...
\node (Batt Check Simple Advanced)[
    above right=0.05cm and 1cm of Batt Check from OFF.north west,
    anchor=south west,
    inner xsep=0.05cm,
    inner ysep=0cm,
    align=left
...
{ [on background layer]
    \node (Voltage Config from Batt Check)[
        advancedtable,
        right=1.4cm of Strobe Modes Actions.south east,
        anchor=south west
    ]
    {
        \spacingnoextra
...
{ [on background layer]
    ...
    -- ([yshift=0.2pt] Blinky Modes border 2)
       % yshift=0.2pt: 1/2 line thickness for outer alignment
    -| (Blinky Modes border 3)
    |- ([yshift=0.2pt] Blinky Modes border 4)
       % yshift=0.2pt: 1/2 line thickness for outer alignment
...
\node (Tactical Mode Config)[
    advancedtable,
    right=1cm of Blinky Modes fit.south east,
    anchor=south west
]
{
    \spacingnoextra
...
{6C} (Tactical Mode from OFF right.50);
