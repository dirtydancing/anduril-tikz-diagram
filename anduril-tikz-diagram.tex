...
\colorlet{onofframplabel-fill}{anybutton-fill}
\colorlet{onofframplabel-text}{onofframplabel-draw}
\colorlet{onofftogglerampstyle-draw}{advanced-draw}
\colorlet{onofftogglerampstyle-fill}{advancedbutton-fill}
\colorlet{onofftogglerampstyle-text}{onofftogglerampstyle-draw}

% any... mode = for Batt Check from OFF
\colorlet{anyconfigmode-draw}{advancedUIswitchline-draw}

% advanced... mode = for strobe modes and blinky modes
\colorlet{advancedconfigmode-draw}{anyconfigmode-draw}
\colorlet{advancedbordermode-draw}{gray!75}
...
% for aux LED channels (channel mode config)
\colorlet{channelmodeconfigaux-mixdraw}{gray!50!violet}
\colorlet{channelmodeconfigaux-white}{darkgray!85!blue}

% for aux LED color (Off and Lockout)
\colorlet{auxLEDcolor-mixdraw}{channelmodeconfigaux-mixdraw}
\colorlet{auxLEDcolor-white}{channelmodeconfigaux-white}
...
% for aux LED channels (channel mode config)
\tikzset{
    channel mode config aux fit/.style={
        button presses basic use fit,
        draw=red!80!channelmodeconfigaux-mixdraw,
        semithick,
        inner sep=0.03cm,
        dash pattern=on 15pt off 90pt,
        postaction={draw=yellow!80!channelmodeconfigaux-mixdraw,
            dash phase=15pt},
        postaction={draw=green!80!channelmodeconfigaux-mixdraw,
            dash phase=30pt},
        postaction={draw=cyan!80!channelmodeconfigaux-mixdraw,
            dash phase=45pt},
        postaction={draw=blue!80!channelmodeconfigaux-mixdraw,
            dash phase=60pt},
        postaction={draw=purple!80!channelmodeconfigaux-mixdraw,
            dash phase=75pt},
        postaction={draw=channelmodeconfigaux-white!80!
                         channelmodeconfigaux-mixdraw,
            dash phase=90pt}
    }
}

% for Off aux LED color
\tikzset{
    aux LED color Off/.style={
        advancedconfig,
        draw=red!80!auxLEDcolor-mixdraw,
        semithick,
        dash pattern=on 10.7 pt off 64.2pt,
        postaction={draw=yellow!80!auxLEDcolor-mixdraw,
            dash phase=10.7pt},
        postaction={draw=green!80!auxLEDcolor-mixdraw,
            dash phase=21.4pt},
        postaction={draw=cyan!80!auxLEDcolor-mixdraw,
            dash phase=32.1pt},
        postaction={draw=blue!80!auxLEDcolor-mixdraw,
            dash phase=42.8pt},
        postaction={draw=purple!80!auxLEDcolor-mixdraw,
            dash phase=53.5pt},
        postaction={draw=auxLEDcolor-white!80!
                         auxLEDcolor-mixdraw,
            dash phase=64.2pt}
    }
}

% for Lockout aux LED color
\tikzset{
    aux LED color Lockout/.style={
        advancedconfig,
        draw=red!80!auxLEDcolor-mixdraw,
        semithick,
        dash pattern=on 11.35pt off 68.1pt,
        postaction={draw=yellow!80!auxLEDcolor-mixdraw,
            dash phase=11.35pt},
        postaction={draw=green!80!auxLEDcolor-mixdraw,
            dash phase=22.7pt},
...
\tcbset{
    ...
    colback=white, % initially black!5!white
...
\newtcbox{\voltageboxred}{
    colback=red!20!voltagebox-mixfill,
    left=0.02cm,
...
\newtcbox{\voltagebox}[1][white]{
    colback=#1!20!voltagebox-mixfill
}

% for the right part of voltage: purple
\newtcbox{\voltageboxpurple}{
    colback=purple!20!voltagebox-mixfill,
    right=0.02cm,
...
\newcommand{\textboxvoltage}{%
    \voltageboxredadv{V%
        \vphantom{Voltage}}%
    \voltageboxadv[yellow]{o%
        \vphantom{Voltage}}%
    \voltageboxadv[green]{lt%
        \vphantom{Voltage}}%
    \voltageboxadv[cyan]{a%
        \vphantom{Voltage}}%
    \voltageboxadv[blue]{g%
        \vphantom{Voltage}}%
...
\newtcbox{\tintrampbox}{
    ...
    interior style={
        left color=orange!20!tintrampbox-mixfill,
        right color=blue!12!tintrampbox-mixfill
    },
...
node[
    anybutton basic use,
    pos=0.53,
    label={ [align=left, xshift=0.525cm] right:
        \infotextany{Ramp up}\\
...
node[
    ...
    label={ [align=left, xshift=0.525cm+1pt] right:
    % +1pt for vertical alignment
...
{ [on above layer]
    \path (OFF.south) edge[
        {Round Cap[sep=3.8cm]}-{Round Cap[sep=2.6cm]},
        anyline,
        anybutton-fill,
        line width=2.4pt,
        out=270,
...
{7H} (Voltage Config from Batt Check.330);
...
{ [on background layer]
    ...
    ]
    {
        ...
        \begin{configtblr}{
            ...
            5  & Auto-tint\\
            6+ & \tikzmarknode{channelmodeconfig-aux}
                              {Aux LED Channels\vphantom{\S}}\\
        \end{configtblr}
    };
}

\node (Channel Mode Config aux LED channels fit)[
    channel mode config aux fit,
    fit=(channelmodeconfig-aux)
]
{};
...
{
    \infotextadvanced{Types of brightness}\\
    \infotextadvanced{memory (1C from Off)}
    \spacingv
    \infotextadvanced{Automatic: last-ramped}\\
    \infotextadvanced{Manual: user's saved}\\
    \infotextadvanced{Hybrid: automatic first,}\\
    \infotextadvanced{manual after n minutes\vphantom{y}}
};
...
]
{
    \spacingnoextra
    \begin{configtblr}{
        row{1} = {abovesep=0.4pt}
        % -0.1pt for horizontal alignment for semithick
    }
        Simple UI Config &\\
        1 & Floor: nC = n of 150\\
        2 & Ceiling: nC = 151 \char"2212{} n\\
...
{ [on background layer]
    \path[
        {->[scale length=1.15, scale width=1.15]}, % for semithick
...
]
{
    ...
    \normalsize Diagram Release 20\\[4pt]
    Diagram Repository:\\
...
]
{
    ...
    \begin{configtblr}{
        row{2-7}     = {rowsep=0pt},
        row{3}       = {belowsep=0.5pt},
        row{Y}       = {abovesep=2pt},
        row{Z}       = {abovesep=1.5pt},
        cell{Y-Z}{1} = {c=2}{}
    }
        Button Presses\vphantom{Config} &\\
        \tikzmarknode{buttonpresses-1C}{1C:} &
        \tikzmarknode{buttonpresses-Click}{Click\hspace{0.015cm}}\\
        \tikzmarknode{buttonpresses-1H}{1H:} &
        \tikzmarknode{buttonpresses-Hold}{Hold}\\
        2C: & Click, Click\\
        2H: & Click, Hold\\
        ...
        \infotextany{Defaults vary by light.} &\\
    \end{configtblr}
};
