...
\tikzset{
    channel mode config aux fit/.style={
        ...
        postaction={draw=purple!80!channelmodeconfigaux-mixdraw,
            dash phase=75pt},
        postaction={draw=lightgray!80!channelmodeconfigaux-mixdraw,
            dash phase=90pt}
    }
}
...
\tikzset{
    aux LED color Off/.style={
        ...
        postaction={draw=purple!80!auxLEDcolor-mixdraw,
            dash phase=53.5pt},
        postaction={draw=lightgray!80!auxLEDcolor-mixdraw,
            dash phase=64.2pt}
    }
}
...
\newcommand{\textboxpovd}{%
    \voltageboxredadv{Post%
        \vphantom{Post-Off Voltage Display}}%
    \voltageboxadv[yellow]{-Off%
        \vphantom{Post-Off Voltage Display}}%
    \voltageboxadv[green]{\nobreakspace Vol%
        \vphantom{Post-Off Voltage Display}}%
    \voltageboxadv[cyan]{tage%
        \vphantom{Post-Off Voltage Display}}%
    \voltageboxadv[blue]{\nobreakspace Dis%
        \vphantom{Post-Off Voltage Display}}%
    \voltageboxpurpleadv{play%
        \vphantom{Post-Off Voltage Display}}%
}
...
]
{
    ...
    \normalsize Diagram Release 13\\[4pt]
    Diagram Repository:\\
