...
\coordinate (Blinky Modes border 2) at
    ...
    + (0.15cm, 0.3cm+0.2pt)$); % yshift=0.2pt
...
\coordinate (Blinky Modes border 4) at
    ...
    + (-0.3cm, -0.3cm+0.2pt)$); % yshift=0.2pt
...
\node (Ramp Extras Config from ON)[
    advancedtable,
    right=0.6cm of Ramp Config from ON.north east,
    anchor=north west
]
{
    \spacingnoextra
...
\node (Simple UI Config from OFF)[
    advancedtable,
    right=0.6cm of Ramp Extras Config from ON.north east,
    anchor=north west
]
{
    \spacingnoextra
...
\node (Misc Config from OFF)[
    advancedtable,
    right=0.6cm of Simple UI Config from OFF.north east,
    anchor=north west
]
{
    \spacingnoextra
...
\node (Button Presses)[
    buttonpressesinfo,
    left=0.6cm of Anduril 2 UI.north west,
    anchor=north east
]
{
    \spacingnoextra
...
\matrix (Legend)[
    matrixlegendinfo,
    left=0.6cm of Button Presses.north west,
