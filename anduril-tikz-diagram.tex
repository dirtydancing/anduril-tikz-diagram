...
{3C/6C}(Toggle Ramp Style from ON.south);
...
% Momentary Turbo 3H/4H from ON, ramp image
{ [on above layer]
    \draw (Ramp.west) edge[
...
{10H} (Ramp Extras Config from ON.280);
...
{10H} (Simple UI Config from OFF.303);
...
]
{
    ...
    \normalsize Diagram Release 19\\[4pt]
    Diagram Repository:\\
