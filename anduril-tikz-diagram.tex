...
% for aux LED channels colors (channel mode config)
\colorlet{auxledchannelsbox-frame}{voltagebox-frame}
\colorlet{auxledchannelsbox-mixfill}{voltagebox-mixfill}
\colorlet{auxledchannelsbox-text}{voltagebox-text}
...
\newtcbox{\auxledchannelsbox}{
    colframe=auxledchannelsbox-frame,
    opacityframe=0,
    boxrule=0cm,
    skin=enhanced, % for interior style
    interior style={
        left color=red!25!auxledchannelsbox-mixfill,
        right color=green!30!auxledchannelsbox-mixfill,
        middle color=yellow!25!auxledchannelsbox-mixfill,
    },
    coltext=auxledchannelsbox-text,
    left=0cm,
    right=0cm,
    top=0cm,
    bottom=0cm,
...
]
{
    ...
    \begin{configtblr}{
        ...
        4  & Tint Ramp\\
        5  & Auto-tint\\
        6+ & \auxledchannelsbox{Aux LED Channels\vphantom{y}}\\
    \end{configtblr}
};
...
]
{
    ...
    \normalsize Diagram Release 09\\[4pt]
    Diagram Repository:\\
