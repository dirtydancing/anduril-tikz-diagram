...
node[
    anybutton basic use,
    pos=0.5,
    label={ [align=left, xshift=0.62cm] right:
        \infotextany{Ramp up}\\
...
node[
    anybutton,
    pos=0.42,
    label={ [align=left, xshift=0.62cm+0.8pt] right:
...
{ [on background layer]
    \node (Voltage Config from Batt Check)[
        advancedtable,
        above right=0.4cm and 1.6cm of
...
]
{
    ...
    \normalsize Andúril 2 Release 2025-04-29\\[3pt]
