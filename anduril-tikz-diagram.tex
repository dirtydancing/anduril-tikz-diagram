...
% Ramp Config from ON %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Channel Mode Config from ON OFF Lockout %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\node (Manual Memory from ON)[
    advancedconfig,
    below=1.2cm of Ramp Config from ON.south west,
    anchor=north west
]
{
...
(Manual Memory from ON.327);

% Sunset Timer from ON
\node (Sunset Timer from ON)[
    advancedconfig,
    below=0.6cm of Manual Memory from ON.south west,
    anchor=north west
]
{
...
% Channel Mode Config from ON OFF Lockout %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node (Channel Mode Config from ON OFF Lockout)[
    advancedtable,
    above left=1.45cm and 2.2cm of OFF.center,
    anchor=south
]
{
    \begin{tabular}{m{0.35cm} l}
...
{9H} (Channel Mode Config from ON OFF Lockout.242);
\draw (OFF.north) edge[
    ->,
    advancedline,
    shorten >=-0.7pt,
...
node[
    ...
    pos=0.6,
    label={
        [align=left, xshift=0.1cm, yshift=-0.025cm]left:{
            \begin{tabular}{l}
                If no Misc Config
            \end{tabular}
        }
...
{9H} (Channel Mode Config from ON OFF Lockout.298);
\draw (Lockout.north) edge[
    ->,
    advancedline,
    out=90,
...
{9H} (Channel Mode Config from ON OFF Lockout.60);

% Simple UI Config from OFF %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\node (Simple UI Config from OFF)[
    advancedtable,
    right=1.2cm of Ramp Extras Config from ON.north east,
    anchor=north west
]
{
    \begin{tabular}{m{0.35cm} l}
...
\draw (OFF.north) edge[
    {Round Cap[sep=9.1cm]}-{Round Cap[sep=1cm]},
    advancedline,
    white,
    line width=2.4pt,
    out=90,
...
{10H} (Simple UI Config from OFF.296);
...
\draw (OFF.north) edge[
    {Round Cap[sep=5.8cm]}-{Round Cap[sep=0.7cm]},
    advancedline,
    white,
    line width=2.4pt,
    out=90,
...
]
{
    ...
    \normalsize Diagram Release 16\\[2.0ex]
    Diagram Repository:\\
